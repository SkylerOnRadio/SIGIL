Download the code and to run it instal the node modules for each folder and then run "npm run server" to run the backend and "npm run dev" to run the frontend.
